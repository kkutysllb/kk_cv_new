...
text_labels_mini_imagenet100 = ['analog clock', 'backpack, back pack, knapsack, packsack, rucksack, haversack', 
                                ...
                                'bolo tie, bolo, bola tie, bola', 'bookcase', 'bottlecap', 'brassiere, bra, bandeau',
                                'broom', 'bucket, pail', 'buckle', 'candle, taper, wax light', 
                                'can opener, tin opener', 'carton', 
                                'cellular telephone, cellular phone, cellphone, cell, mobile phone',
                                'cleaver, meat cleaver, chopper', 'clog, geta, patten, sabot', 
                                'coffee mug', 'coil, spiral, volute, whorl, helix', 'combination lock', 
                                'computer keyboard, keypad', 'confectionery, confectionary, candy store', 
                                'corkscrew, bottle screw', 'cowboy hat, ten-gallon hat', 'crash helmet', 
                                'Crock Pot', 'desk', 'desktop computer', 'digital clock', 'digital watch', 
                                'dishrag, dishcloth', 'dumbbell', 'Dutch oven', 'electric fan, blower',
                                'face powder', 'feather boa, boa', 'file, file cabinet, filing cabinet',
                                'folding chair', 'fountain pen', 'frying pan, frypan, skillet', 'goblet',
                                'hair slide', 'hand blower, blow dryer, blow drier, hair dryer, hair drier',
                                'handkerchief, hankie, hanky, hankey', 'hard disc, hard disk, fixed disk',
                                'hook, claw', 'hoopskirt, crinoline', 'iPod', 'jean, blue jean, denim',
                                'jersey, T-shirt, tee shirt', 'knot', 'ladle', 'lampshade, lamp shade',
                                'laptop, laptop computer', 'letter opener, paper knife, paperknife',
                                'lighter, light, igniter, ignitor', 'lipstick, lip rouge', 'Loafer',
                                'lotion', 'matchstick', 'maypole', 'miniskirt, mini', 'mitten',
                                'modem', 'monitor', 'mouse, computer mouse', 'nail', 'necklace', 
                                'nipple', 'notebook, notebook computer', 'packet', 'padlock',
                                'paintbrush', "pajama, pyjama, pj's, jammies", 'paper towel',
                                'pencil box, pencil case', 'pencil sharpener', 'perfume, essence',
                                'pill bottle', 'pillow', 'pitcher, ewer', 'plastic bag',
                                'Polaroid camera, Polaroid Land camera', 'pop bottle, soda bottle',
