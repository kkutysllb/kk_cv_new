...
if __name__ == "__main__":
    ...
    # 模型初始化
    model_resnet18 = ResNet_V2(Bottleneck, [3, 8, 36, 3])
    # 损失函数、优化器、调度器
    ...
    # 训练  
    trainer = kk_ImageClassifierTrainer(config, model_resnet18, criterion, optimizer, scheduler=None)
